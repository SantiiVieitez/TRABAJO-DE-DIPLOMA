...
namespace DAL
{
    ...
    {
        protected basededatos dao;
        protected DataSet ds;
        protected readonly string _tableName;
        protected readonly string _primaryKeyColumn;

        // Constructor normal
        public BaseDAL(string tableName, string primaryKeyColumn)
        {
            dao = new basededatos();
            ds = new DataSet();
        ...
        public BaseDAL(string tableName, string primaryKeyColumn, basededatos daoInyectado)
        {
            dao = daoInyectado;
            ds = new DataSet();
            _tableName = tableName;
